...
>
> **Focus**: Data Structures & Algorithms + Systems Design + Muscle Memory (Katas)
...
- **8:30 - 8:45 AM**: **Kata Warmup** (15 min)
  - `/kata session`
  - Practice 2-3 patterns from memory
  - Log times and bugs
  - `just kata-reset-pattern <pattern>`
- **8:45 - 10:30 AM**: **LeetCode Deep Work #1** (1h 45min)
  - `/ritual` for first problem
  - Full 4-phase ritual (45-60 min)
  - Second problem if first finishes early
  - Document learnings
- **10:30 - 10:45 AM**: Break (walk, stretch, water)
- **10:45 AM - 12:30 PM**: **LeetCode Deep Work #2** (1h 45min)
  - `/ritual` for second/third problem
  - Focus on applying morning kata patterns
  - Update correlation: "I solved X, Y, Z"
  - Commit work
...
- **1:45 - 3:30 PM**: **Systems Design Study** (1h 45min)
  - **Mon/Wed/Fri**: Learn fundamentals (caching, scaling, databases)
    - Read concept in `incantations/fundamentals/`
    - Implement in Python
    - Take notes on trade-offs
  - **Tue/Thu**: Practice full system designs
    - `/design` - Work with systems-sage
    - RADIO framework (Requirements, Architecture, Data, Interface, Optimization)
    - Draw diagrams, explain out loud, record yourself
  - **Sat**: Mock system design interviews (timed, 45 min)
- **3:30 - 3:45 PM**: Break
- **3:45 - 5:00 PM**: **Flexible Study Time** (1h 15min)
  - Review weak topics from morning
  - Additional LeetCode problem if feeling strong
  - Read solutions to problems you struggled with
  - Study data structures in `runes/structures/`
...
- **5:30 - 6:00 PM**: **Daily Review & Planning** (30 min)
  - Update progress in READMEs
  - Commit all work: `/commit-dsa`, `/commit-systems`
  - Review self-assessment scores
  - Plan tomorrow's focus
  - Update correlation guide via kata-master

**📊 Total Daily Study Time**: 6-7 hours (sustainable for 14 weeks)
...
- **9:30 - 10:00 AM**: **Weekly Review** (30 min)
  ...
  - `/kata report` - kata-master correlation
  - Review sprint progress vs. targets
- **10:00 - 11:00 AM**: **Strategic Planning** (1 hour)
  - What went well this week?
  - What needs more focus?
  - Adjust next week's priorities
  - Update KATA_CANTRIP_CORRELATION.md manually if needed
...
**Total Sunday**: 2-4 hours (flexible, emphasize rest)
...
- **Systems Focus**: Fundamentals (scaling, caching, databases, load balancing)
...
- **Systems Focus**: 3 medium designs (Twitter, Instagram, Uber)
- **Mock Interviews**: 2-3 full mock interviews (LeetCode + System Design)
- **Daily Commitment**: 6-7 hours
...
- ✅ 7 system designs completed
- ✅ 5-8 fundamentals mastered
- ✅ Interview-ready confidence

---

### Phase 2: Weeks 7-14 (Jan 1 - Feb 28) - Sustained Excellence
...
- **Kata**: Maintain muscle memory (15 min daily, non-negotiable)
...
- **Binary Search**: Complete 100 reps goal
- **Systems**: 15-20 total designs
- **Mock Interviews**: 6-10 total
...
- **Mock Interviews**: 2-3 full mocks
...
4. **Physical health**: Walk daily, exercise 3x/week
...
/kata session           # Warmup (15 min)
/ritual                 # LeetCode practice

# Afternoon
/design                 # Systems design

# Evening
/kata session           # Reinforcement
/check-in               # Progress check
/commit-dsa             # Commit work
/commit-systems         # Commit systems work

# Sunday
/weekly-review          # Full week review
/kata report            # Correlation analysis
```
...
- **Kata Logs**: Track in kata.py files
...
- **Git history**: Visual progress over time
- **Weekly reviews**: Data-driven accountability
...
- 1:30-3:30: Systems design (Study scaling fundamentals)
- 3:30-5:00: Flexible (Review, additional problem, or rest)
...
- 12:30-1:30: Lunch break
- 1:30-3:30: Systems design (Practice: URL Shortener)
- 3:30-5:00: Flexible
- 5:00-6:00: Kata reinforcement, daily review, commit
...
- [ ] 15-20 system designs completed
- [ ] Multiple interview processes or job offers
...
4. **Check self-assessment scores** - Identify weak areas
5. **Extend timeline** - February buffer exists for this reason
