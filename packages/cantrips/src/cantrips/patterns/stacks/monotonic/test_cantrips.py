"""
Pytest tests for Stack Monotonic cantrips.

Quick Reference:
    pytest test_cantrips.py                       # Run all
    pytest test_cantrips.py::TestDailyTemps       # Run specific
    pytest -m cantrip4                            # Run by marker
"""
...
class TestDailyTemperatures:
    """Tests for Daily Temperatures cantrip."""
...
class TestNextGreaterElement:
    """Tests for Next Greater Element I cantrip."""
...
class TestNextGreaterElementsCircular:
    """Tests for Next Greater Element II cantrip."""
...
class TestStockSpanner:
    """Tests for Online Stock Span cantrip."""
...
class TestLargestRectangle:
    """Tests for Largest Rectangle in Histogram cantrip."""
